        ...
        <div class="col-md-12">
            <div class="card text-center">
                <div class="card-header">
                  <strong class="font-weight-bold">Edit Supplier </strong>
                ...
                @endif
                    ...
                    <form action="{{route('acc.supplier_update',$supplier->id)}}" method="post" enctype="multipart/form-data">
                     ...
                     @csrf
                        ...
                        <div class="form-group {{$errors->has('supplier_code') ? 'has-error' : ''}}">
                             ...
                             <input type="text" name="code"  id="" class="form-control" value="{{$supplier->code}}">
                        ...
                        <div class="form-group {{$errors->has('supplier_name') ? 'has-error' : ''}}">
                             ...
                             <input type="text" name="supplier_name" id="" class="form-control" value="{{$supplier->supplier_name}}">
                        ...
                        <div class="form-group {{$errors->has('supplier_address') ? 'has-error' : ''}}">
                             ...
                             <textarea name="supplier_address" id="" cols="30" rows="5" class="form-control" value="">{{$supplier->supplier_address}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('supplier_phone') ? 'has-error' : ''}}">
                             ...
                             <input type="text" name="supplier_phone" id="" class="form-control"  value="{{$supplier->supplier_phone}}">
