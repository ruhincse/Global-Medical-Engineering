        ...
        <!-- card -->
            <div class="card" style="height: 535px;">
                ...
                <h3>Create Division</h3>
                    ...
                    @include('_partials_settings_.divisions.create')
                </div>
        ...
        <div class="col-md-6">
            <div class="card" style="height: 535px;">
                <div class="card-body">
                    ...
                    @include('_partials_settings_.divisions.list')
                </div>
            </div>
        </div>
    </div>
...
@include('_partials_settings_.divisions.update_modal')
<!-- /.modal -->

<!-- delete modal -->
@include('_partials_settings_.divisions.delete_modal')
<!-- End delete modal -->
