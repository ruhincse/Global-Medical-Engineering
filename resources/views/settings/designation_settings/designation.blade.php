        ...
        <!-- card -->
            <div class="card" style="height: 535px;">
                ...
                <h3>Create Designation</h3>
                    ...
                    @include('_partials_settings_.designations.create')
                </div>
        ...
        <div class="col-md-6">
            <div class="card" style="height: 535px;">
                <div class="card-body">
                    ...
                    @include('_partials_settings_.designations.list')
                </div>
            </div>
        </div>
    </div>
...
@include('_partials_settings_.designations.update_modal')
<!-- /end update modal -->

<!-- delete modal -->
@include('_partials_settings_.designations.delete_modal')
<!-- End delete modal -->
@endsection
@push('end_js')
