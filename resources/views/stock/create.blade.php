...
<div class="card">
    ...
    <div class="card-body">
        <form class="floating-labels m-t-40" action="{{route('stock.product.Store')}}" method="POST" enctype="multipart/form-data" data-parsley-validate>
            {{csrf_field()}}
            <div class="row">
               ...
               <div class="col-md-6">
                            <div class="form-group m-b-40 " >
                             ...
                             <div class="form-group m-b-40 " >
                                        <input type="text" class="form-control" id="input1" name="purchase_price">
